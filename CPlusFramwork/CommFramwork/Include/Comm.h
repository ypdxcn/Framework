...
public:
	...
	//对AIO提供的发送数据的接口
	virtual int SendData(PKEY_CONTEXT pKey) = 0;
...
public:
	...
	virtual int Register(REG_INF& stRegInf) = 0;
	virtual void UnRegister(tsocket_t sSocket) = 0;
	virtual void UnRegister(REG_INF& stRefInf) = 0;
