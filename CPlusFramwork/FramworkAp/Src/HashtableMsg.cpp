...
void HashtableMsg::AddRecord(map<string,string> mapRec)
{
	m_vRecords.push_back(mapRec);
}
...
void HashtableMsg::AddFileds(string & sFileds)
{
	m_vFields = strutils::explode(ApConst::SEPARATOR_RECORD[1], sFileds);
}