...
UTIL_API std::string LeftSubRight(const string& sSrc, char c, size_t nCount = 1);
UTIL_API std::string LeftSubRight(const string& sSrc, const string& sObj, size_t nCount = 1);
